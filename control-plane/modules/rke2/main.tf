...
module "aws_infra_rke2" {
  source = "git::https://github.com/git-ival/rke2-aws-tf.git//?ref=add-userdata-logfile-on-init"
...
module "rke2_monitor_pool" {
  ...
  source = "git::https://github.com/git-ival/rke2-aws-tf.git//modules/agent-nodepool?ref=add-userdata-logfile-on-init"
