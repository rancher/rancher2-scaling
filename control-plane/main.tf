...
locals {
  ...
  rancher_url        = var.k8s_distribution == "k3s" ? try(module.k3s[0].rancher_url, "") : var.k8s_distribution == "rke1" || var.k8s_distribution == "rke2" ? try(module.install_common[0].rancher_url, "") : ""
  rancher_token      = var.k8s_distribution == "k3s" ? try(module.k3s[0].rancher_token, "") : var.k8s_distribution == "rke1" || var.k8s_distribution == "rke2" ? try(module.install_common[0].rancher_token, "") : ""
}
